...
module.exports = ({book, root, indent}) => {
  ...
  archive.append(
    xml('package', {xmlns: 'http://www.idpf.org/2007/opf', 'unique-identifier': 'uuid', version: '2.0'},
      ...
      h('manifest',
        ...
        book.coverURL ? h('item', {id: 'cover', 'media-type': 'application/xhtml+xml', href: 'text/_cover.xhtml'}) : [],
      ...
      h('spine', {toc: 'toc'},
        book.coverURL ? h('itemref', {idref: 'cover'}) : [],
  ...
  if (book.coverURL) archive.append(
